const fs = require('fs');
let code = fs.readFileSync('e:/cod2/Bia_benh_an_YHCT_A3 290626.html', 'utf8');
...
fs.writeFileSync('e:/cod2/Bia_benh_an_YHCT_A3 290626.html', code, 'utf8');
console.log('Done YHCT');
