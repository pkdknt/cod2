    ...
    <div className="flex flex-col h-full gap-2">
      ...
      <div className="flex items-center justify-between gap-3 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-base font-black text-slate-800 tracking-tight">NHƠN TÂM BHYT CRM</h1>
        </div>
            ...
            <div className="flex items-center gap-2">
              {isDeleteUnlocked && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-xs font-bold text-red-700 hover:bg-red-100 transition-colors shadow-sm"
                >
              ...
              <button
                ...
                title={isDeleteUnlocked ? 'Khóa lại chức năng xóa' : 'Mở khóa để xóa danh sách'}
              ...
              >
                {isDeleteUnlocked ? <Unlock className="h-3.5 w-3.5" /> : <Lock className="h-3.5 w-3.5" />}
              </button>
            </div>
          )}
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-xl bg-teal-600 px-3 py-2 text-xs font-bold text-white shadow-md shadow-teal-900/10 hover:bg-teal-500 transition-colors"
          >
            <Plus className="h-3.5 w-3.5" /> Thêm khách mới
          </button>
        </div>
      </div>
